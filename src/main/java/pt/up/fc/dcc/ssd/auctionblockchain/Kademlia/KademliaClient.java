...
public class KademliaClient {
    ...
    public void bootstrap(KademliaNode bootstrappingNode) throws InterruptedException {
        KademliaBootstrap bootstrap = new KademliaBootstrap(bucketManager, this, bootstrappingNode);
        bootstrap.start();
        logger.log(Level.INFO, "Bootstrapping kademlia network... Wait " + KademliaUtils.bootstrapTimeMsecs + " milliseconds...");
        Thread.sleep(KademliaUtils.bootstrapTimeMsecs);
        return;
    }
...
//                    logger.log(Level.INFO, "Added some information.");
    ...
    public <T> boolean store(byte[] serviceKey, T value) {
...
//                logger.log(Level.INFO, "Success in storeGRPC for node " + node);
    ...
    public <T> List<T> findNode(byte[] key) {
        TreeSet<KademliaNodeWrapper> shortList = new TreeSet<>(new KademliaNodeWrapperCompare());
        TreeSet<KademliaNodeWrapper> probedNodes = new TreeSet<>(new KademliaNodeWrapperCompare());
...
//                logger.log(Level.INFO, "Could not find a better node because the list was empty.");
    ...
    public <T> List<T> findValue(byte[] nodeKey, byte[] key) {
        TreeSet<KademliaNodeWrapper> shortList = new TreeSet<>(new KademliaNodeWrapperCompare());
        TreeSet<KademliaNodeWrapper> probedNodes = new TreeSet<>(new KademliaNodeWrapperCompare());
